...
The GitHub Pages prototype edits an in-memory menu. Export/import preserves a working copy. Publish a revised seed JSON through GitHub to change what fresh visitors/TVs load. There is no server, login, shared admin storage, or live device synchronization in this first prototype. Do not treat browser-session edits as restaurant-wide updates.
